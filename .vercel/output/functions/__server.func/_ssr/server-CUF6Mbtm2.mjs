...
import { n as createCsrfMiddleware } from "./server-CUF6Mbtm.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-TCxHjjG0.mjs");
...
var manifest = { "52202c0fe9cced691b9e5c401ded308dd2f1b2db932a05ff8e37a647a31de2a2": {
	functionName: "createAppointment_createServerFn_handler",
	importer: () => import("./appointments.functions-BS-fK1iG.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DhYNb39O.mjs").then((n) => n.t),
		import("./start-Ba-T5vAb.mjs"),
